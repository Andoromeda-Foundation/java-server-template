ALTER TABLE `power_broker`.`regular_demand_declare_plans`
  ...
  ADD COLUMN `dept` VARCHAR(45) NULL AFTER `customer_name`,
  ADD COLUMN `district` VARCHAR(45) NULL AFTER `dept`,
  ADD COLUMN `distribution_no` VARCHAR(45) NULL AFTER `district`;
